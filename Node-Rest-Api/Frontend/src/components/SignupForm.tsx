      ...
      <div className="rounded-md shadow-sm space-y-4">
        <div>
          ...
          <input
            ...
            autoComplete="email"
            required
            className="mt-1 appearance-none block text-white w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
